...
const ProjectData = [
    ...
    new Project(Weather, "Simply Weather", "The application provides real-time weather updates for a variety of cities, sourcing its data from a Weather API.", "", "https://github.com/smilenayeon/Simply-Weather.git"),
